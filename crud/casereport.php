...
if (isset($_POST["submit"])) {
   ...
   $sql = "INSERT INTO `offense` (`full_name`, `stud_no`, `depart`, `yr_lvl`, `section`, `offense`, `offense_no`, `sunction`) 
           VALUES ('$full_name', '$stud_no', '$depart', '$yr_lvl', '$section', '$offense', '$offense_no', '$sunction')";
